...
@Component({
  ...
  templateUrl: './reportes5.component.html',
  styleUrls: ['./reportes5.component.css']
})
export class Reportes5Component implements OnInit {
    ...
    loadReport = () => {
      this.serviceProyecto.RptListSuppliesDecreaseByMonth().subscribe(
        (data: any) => {
          debugger
          data.Value.forEach(element => {
            var obj = [
              element.DateGroup,
              element.QuantityDecrease,
            ]
